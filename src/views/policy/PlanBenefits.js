...
const PlanBenefits = () => {
  const [benefits, setBenefits] = useState([
    {
      id: 1,
      name: "Medical Expenses including Evacuation",
      sumInsured: 100000,
      deductibles: 100,
      checked: false,
    },
  ...
  const handleViewDetails = useCallback(() => {
    ...
    window.location.href = "/dashboard/policy-view";
    handleClose();
  }, [selectedBenefitId]);
      ...
      <Paper elevation={3} sx={{ borderRadius: "12px", overflow: "hidden" }}>
        ...
        <TableContainer sx={{ maxHeight: "calc(100vh - 250px)" }}>
          ...
          <Table stickyHeader>
            ...
            <TableBody>
              {benefits.map(
                ({ id, name, sumInsured, deductibles, checked }) => (
                  <TableRow
                    key={id}
                    sx={{
